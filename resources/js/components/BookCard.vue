<template>
  <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col h-full">
    <div class="relative aspect-[2/3] overflow-hidden">
      <img :src="coverImage || '/images/book-placeholder.svg'" :alt="title" class="w-full h-full object-cover" onerror="this.src='/images/book-placeholder.svg'; this.onerror=null;" />
    ...
    <div class="p-4 flex-grow">
      ...
      <p class="text-sm text-gray-600">{{ author || 'Penulis tidak diketahui' }}</p>
    </div>
